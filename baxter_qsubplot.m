...
function baxter_qsubplot(t, q)
    ...
    figure
    hold on
    subplot(7,1,1); hData1 = plot(t, q(:,1));hold on; hXLabel1 = xlabel('t (s)'); hYLabel1 = ylabel('q_1 (rad)');
    subplot(7,1,2); hData2 = plot(t, q(:,2));hold on; hXLabel2 = xlabel('t (s)'); hYLabel2 = ylabel('q_2 (rad)');
    subplot(7,1,3); hData3 = plot(t, q(:,3));hold on; hXLabel3 = xlabel('t (s)'); hYLabel3 = ylabel('q_3 (rad)');
    subplot(7,1,4); hData4 = plot(t, q(:,4));hold on; hXLabel4 = xlabel('t (s)'); hYLabel4 = ylabel('q_4 (rad)');
    subplot(7,1,5); hData5 = plot(t, q(:,5));hold on; hXLabel5 = xlabel('t (s)'); hYLabel5 = ylabel('q_5 (rad)');
    subplot(7,1,6); hData6 = plot(t, q(:,6));hold on; hXLabel6 = xlabel('t (s)'); hYLabel6 = ylabel('q_6 (rad)');
    subplot(7,1,7); hData7 = plot(t, q(:,7));hold on; hXLabel7 = xlabel('t (s)'); hYLabel7 = ylabel('q_7 (rad)');
